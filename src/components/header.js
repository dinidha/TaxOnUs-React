...
const Header = (props) => {
  return (
    <div className={`header-header ${props.rootClassName} `}>
      ...
      >
        <Link to="/" className="header-logo TaxObey">
          {props.logo}
        </Link>
        <div data-thq="thq-navbar-nav" className="header-desktop-menu">
          <nav className="header-links">
            ...
            <Link to="/tax-services" className="header-nav32">
              {props.nav32}
            </Link>
        ...
        <div data-thq="thq-burger-menu" className="header-burger-menu">
          <svg viewBox="0 0 1024 1024" className="socialIcons header-icon">
            <path
        ...
        >
          <div className="header-nav">
            <div className="header-top">
              <span className="TaxObey">{props.logo1}</span>
            ...
            <nav className="header-links1">
              ...
              <Link to="/tax-services" className="header-nav321 bodySmall">
                {props.nav321}
              </Link>
              <Link
                to="/accounting-services"
                className="header-nav421 bodySmall"
              >
                {props.nav421}
              </Link>
...
Header.defaultProps = {
  ...
  login1: 'Login',
  login: 'Login',
  nav42: 'Accounting Services',
  nav521: 'Contact Us',
  rootClassName: '',
  nav12: 'Home',
  nav421: 'Accounting Services',
  nav32: 'Tax Services',
}
