        ...
        <footer className="footerContainer about-footer1">
          <div className="about-container1">
            ...
            <nav className="about-nav">
              ...
              <span className="about-nav22 bodySmall">About Us</span>
              <span className="about-nav32 bodySmall">Resources</span>
              <span className="about-nav42 bodySmall">Contact Us</span>
            </nav>
          </div>
