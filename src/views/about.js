          ...
          <div className="about-container05">
            <div className="freePricingCard about-pricing-card">
              <div className="about-container06">
                <span className="about-text036 heading3">Small business</span>
                <span>
              ...
              <div className="about-container07">
                <span className="about-text040">LKR</span>
                <span className="about-free-plan-price">28,500</span>
                <span className="about-text041">/ month</span>
              </div>
              <div className="about-feature-container">
                <div className="about-feature">
                  <h1 className="about-text042">Account reconciliation</h1>
                  <div className="about-sub-feature">
                    <span className="about-text043">✔</span>
                    <span>Bank accounts up to 3</span>
                  </div>
                  <div className="about-sub-feature01">
                    <span className="about-text044">✔</span>
                    <span>
                  ...
                  <div className="about-sub-feature02">
                    <span className="about-text045">✔</span>
                    <span>
                  ...
                  <span className="about-text046">LKR 9000</span>
                </div>
                <div className="about-feature1">
                  <h1 className="about-text047">Monthly financials</h1>
                  <div className="about-sub-feature03">
                    <span className="about-text048">✔</span>
                    <span>Balance Sheet</span>
                  </div>
                  <div className="about-sub-feature04">
                    <span className="about-text049">✔</span>
                    <span>
                      <span>
                        Profit &amp; Loss
                        <span
                  ...
                  <div className="about-sub-feature06">
                    <span className="about-text057">✔</span>
                    <span>
                ...
                <div className="about-feature2">
                  ...
                  <div className="about-sub-feature07">
                    <span className="about-text065">✔</span>
                    <span>Stock report up to 20 items</span>
                  </div>
                  <span className="about-text066">LKR 2500</span>
                </div>
                <div className="about-feature3">
                  <h1 className="about-text067">
                    Employee Funds
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                  ...
                  <span className="about-text070">LKR 2500</span>
                </div>
                <div className="about-feature4">
                  <h1 className="about-text071">
                    Advice
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                  ...
                  <div className="about-sub-feature10">
                    <span className="about-text072">✔</span>
                    <span>
                      Accountant and business service meeting up to an hour
                    </span>
                  </div>
                  <span className="about-text073">LKR 2000</span>
                </div>
                <div className="about-feature5">
                  <h1 className="about-text074">Software and portals</h1>
                  ...
                  <div className="about-sub-feature12">
                    <span className="about-text076">✔</span>
                    <span>
                  ...
                  <div className="about-sub-feature13">
                    <span className="about-text077">✔</span>
                    <span>
                      <span>
                  ...
                  <span className="about-text082">LKR 4500</span>
                </div>
              </div>
            ...
            <div className="proPricingCard about-pricing-card2">
              <div className="about-container16">
                <span className="about-text092 heading3">
              ...
              <div className="about-container18">
                ...
                <div className="about-container21">
                  <span className="about-text102">✔</span>
                  <span className="bodySmall">E-filing included</span>
                </div>
                <div className="about-container22">
                  <span className="about-text103">✔</span>
                  <span className="bodySmall">
                ...
                <div className="about-container23">
                  <span className="about-text104">✔</span>
        ...
        <div className="faqContainer">
          <div className="about-faq1">
            <div className="about-container24">
              ...
              <h2 className="about-text122 heading2">Common questions</h2>
              <span className="about-text123 bodyLarge">
                <span>
      ...
      <div className="about-footer">
        <footer className="footerContainer about-footer1">
          ...
          <div className="about-container27">
            <span className="bodySmall about-text126">
