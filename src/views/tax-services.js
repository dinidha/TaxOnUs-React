      ...
      <div className="tax-services-footer">
        <footer className="footerContainer tax-services-footer1">
          <div className="tax-services-container27">
            ...
            <nav className="tax-services-nav">
              <span className="bodySmall">Services</span>
              <span className="tax-services-nav22 bodySmall">About Us</span>
              <span className="tax-services-nav32 bodySmall">Resources</span>
              <span className="tax-services-nav42 bodySmall">Contact Us</span>
            </nav>
          </div>
          ...
          <div className="tax-services-container28">
            ...
            <div className="tax-services-icon-group">
              <svg
              ...
              <svg
                ...
                className="tax-services-icon2 socialIcons"
              >
              ...
              <svg
                ...
                className="tax-services-icon4 socialIcons"
              >
